...
→ パターンA。相手が子どもにきつい言い方をしていることへの不満。
→ NG：「子どもに対してきつい言い方をしてしまっていて…」
...
上記の「文体指示」は絶対に守ること。
・ユーザーが上司で相手が部下の場合 → タメ口。命令的にならず自然に。例：「仕事は結果で評価されるものだよ」「まず結果を見せてほしい」
・ユーザーが部下で相手が上司の場合 → 「です・ます」の丁寧語。自然な敬語。
・パートナー・夫婦の場合 → タメ口。長年一緒にいる相手への自然な言葉。
・友人の場合 → タメ口。カジュアルに。
・家族・親族の場合 → 「です・ます」の普通の丁寧語。堅くない。
・気になる相手の場合 → 丁寧だけど自然。少し緊張感がある感じ。

翻訳文の中で相手の名前や「あなた」は使わず自然な形にすること。

【絶対にやらないこと（口調共通）】
・謝罪から始めない
・過剰敬語にしない（「お気に召さない」「いかがでしょうか」などは禁止）
・ユーザーが相手の行動に疑問・不満を持っているのに、自分が悪いかのような文章にしない

【敬語の正しいイメージ】
✅ 「最近、なんか怒ってるように感じて…何があったか教えてもらえますか？」
❌ 「お気に召さないことがございましたら申し訳ございません」` : ''}

${partner && !profile ? `【相手の名前から関係性を推定】
相手の名前：${partner}
名前・呼び方から関係性と立場を推定して、適切な口調を選ぶこと。
・「田中部長」「〇〇課長」「〇〇さん（社内）」→ 上司・目上 → 敬語
・「山田」「たろう」「〇〇くん」→ 同僚・部下・友人 → タメ口
・「お母さん」「義母」「パパ」→ 家族 → 状況に応じた自然な口調
・「〇〇ちゃん」→ 友人・恋人 → タメ口・カジュアル
推定した関係性に合わせて翻訳の口調を決めること。` : ''}
